...
def load_cnn_vit():
    from cnn_vit_backbone import CNNViTBackbone
    return CNNViTBackbone(embed_dim=512, num_heads=8, depth=6)

def load_cbam_resnet18():
    from cnn_cbam_backbone import CNN_CBAM_Backbone
    model = CNN_CBAM_Backbone()
    print(model)
    return model
...
_BACKBONES = {
    ...
    "cnn_vit": "load_cnn_vit()",
    "cbam_resnet18": "load_cbam_resnet18()",
}
